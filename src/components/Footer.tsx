      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10 pt-16 lg:pt-20 pb-8 relative z-10">
        <div className="grid md:grid-cols-12 gap-12 lg:gap-16 mb-14">
          <div className="md:col-span-5">
            <a href="#" className="flex items-center gap-3.5 mb-5" aria-label="Grow All Coaching home">
          ...
          <div className="md:col-span-3 md:col-start-7">
            ...
            <ul className="space-y-2.5 text-sm font-medium text-white/60">
              <li><a href="#courses" className="hover:text-lime transition-colors">Full-Stack Web Dev</a></li>
              <li><a href="#courses" className="hover:text-lime transition-colors">AI & Machine Learning</a></li>
              <li><a href="#courses" className="hover:text-lime transition-colors">Excel Automation</a></li>
              <li><a href="#internships" className="hover:text-lime transition-colors">Internship Tracks</a></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-4 md:col-start-10">
            ...
            <ul className="space-y-2.5 text-sm font-medium text-white/60">
              ...
              <li><a href="#testimonials" className="hover:text-lime transition-colors">Student Reviews</a></li>
